    ...
    <>
      ...
      <main className="flex justify-center">
        ...
        />
          ...
          {/* Join us section */}
          <section className="relative py-16 px-8 md:px-16 lg:px-24 mt-50">
            {/* Section title */}
            <h2
            ...
            <div className="border-2 border-wedding-purple p-8 md:p-12 relative z-10 bg-white">
              <div className="space-y-6 text-wedding-neutral-700 text-base md:text-lg leading-relaxed text-justify">
                <p>
            ...
            <img
              ...
              alt=""
              className="absolute bottom-0 left-0 w-48 md:w-64 lg:w-80 h-auto z-0 opacity-80"
              aria-hidden="true"
            />
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-16">
              <p
                className="text-xl md:text-2xl text-wedding-coral uppercase tracking-wider"
              ...
              <Link
                href="/rsvp"
                className="bg-wedding-purple text-white px-12 py-3 text-xl uppercase tracking-wider hover:bg-wedding-purple-dark transition-colors"
                style={{ fontFamily: "var(--font-thin-serif)" }}
              >
                RSVP
              </Link>
